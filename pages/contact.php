...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="bgded overlay" style="background-image:url('../images/bgtop.jpg');">
...
<div class="wrapper row2">
  <section id="ctdetails" class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      <h6 class="heading font-x2">Some ways to contact me</h6>
    </div>
    <figure class="one_half first">
      <ul class="nospace clear">
        <li class="block clear"><a href="https://www.facebook.com/jamicahbernandino.jcb" target="_blank"><i class="fab fa-facebook "></i></a> <span><strong>Visit my FB page</strong> www.facebook.com/jamicahbernandino.jcb</span></li>
        <li class="block clear"><a href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=jhambernan22@gmail.com@gmail.com" target="_blank" ><i class="fas fa-envelope"></i></a> <span><strong>Send me e-mail:</strong> jhambernan22@gmail.com</span></li>
        <li class="block clear"><a href="#"><i class="fas fa-map-marker-alt"></i></a> <span><strong>Come visit us:</strong> Not available. Classified information not for public.</span></li>
      </ul>
    </figure>
    <article class="one_half">
      <img src="../images/god.jpg" style="width:500px; height:280px; border-radius:50%" />
    </article>
    <!-- ################################################################################################ -->
  </section>
</div>
